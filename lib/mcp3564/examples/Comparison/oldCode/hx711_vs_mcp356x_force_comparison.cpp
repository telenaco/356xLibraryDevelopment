/**
 * @file hx711_vs_mcp356x_force_comparison.cpp
 ...
 * - MCP_ADC_CS_PIN (7): Connect to MCP356x CS (Chip Select)
 * - MCP_ADC_IRQ_PIN (6): Connect to MCP356x IRQ (Interrupt Request)
