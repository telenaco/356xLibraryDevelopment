/* This program demonstrates using the MCP356x ADC to make continuous measurements on a single differential channel.
The ADC is configured for the DIFF_A channel. An interrupt is triggered when each conversion is complete.
In the main loop, the number of conversions is counted over a 5 second interval. The sample rate is then
...
#define ADC0_CS_PIN 6
#define ADC1_CS_PIN 4
#define ADC2_CS_PIN 2

#define ADC0_IRQ_PIN 7
