/**
 * @file mcp356x_3axis_example.cpp
 * @brief Example of reading data from 3-axis load cells using MCP356x ADCs.
 *
 * This program demonstrates how to set up and read from multiple 3-axis load cells
 * connected to MCP356x ADCs. It initializes three ADCs connected to four 3-axis load
 * cells, calibrates them using polynomial coefficients, and outputs the force data.
 *
